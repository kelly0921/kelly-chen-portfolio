...
export const projects = [
  ...
  },
  {
    ...
    problem: 'Timed-out external actions can leave agents unsure whether an effect already happened.',
    user: 'AI-agent, MCP, backend, platform, and reliability teams.',
  ...
  },
  {
    ...
    problem: 'Ticket planning spreads across showtimes, sale windows, email signals, and provider tabs.',
    user: 'Private workflow now; pattern fits frequent moviegoers and event planners.',
  ...
  },
  {
    ...
    problem: 'Sellers lose payments when buyers lack cash or the same payment app.',
    user: 'Vendors, performers, nonprofits, pop-ups, and donation groups.',
  ...
  },
  {
    ...
    problem: 'Website feedback gets scattered across audits, screenshots, drafts, and unclear next steps.',
    user: 'Consultants, nonprofits, local businesses, and small agencies.',
  ...
  },
  {
    ...
    image: '/assets/project-tandem-how-it-works-section.png',
    imageFit: 'contain',
    ...
    problem: 'Dating apps rarely capture life stage, ambition rhythm, or complementary partner energy.',
    user: 'Ambitious NYC singles ages 21-30 testing a more intentional match signal.',
